...
<template>
  ...
  >
    <div
      v-if="props.slotProps.args[1] === 'success'"
    ...
    <div
      v-if="props.slotProps.args[1] === 'error'"
    ...
    <div
      v-if="props.slotProps.args[1] === 'info'"
    ...
    <div v-html="props.slotProps.args[0]" class="ms-3 text-sm font-normal"></div>
    <button
      @click="props.slotProps.resolve('ok')"
      type="button"
