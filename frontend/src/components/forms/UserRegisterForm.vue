...
const register = async (): Promise<void> => {
  const {data, error} = await auth.register(form);
  ...
  <form @submit.prevent="register" class="max-w-sm mx-auto">
    ...
    <div class="flex items-start mb-5">
      ...
      <label for="terms" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
        I agree with the <RouterLink to="/terms-and-conditions" class="text-blue-600 hover:underline dark:text-blue-500">terms and conditions</RouterLink>
      </label>
    </div>
